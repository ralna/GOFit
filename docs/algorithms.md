...
:type jac: None or callable
:param int samples: number of Latin Hypercube starting points for the local solver
:param int maxit: maximum number of iterations for each local solver run
:param float eps_r: residual stopping tolerance
:param float eps_g: norm of gradient stopping tolerance
:param float eps_s: norm of step stopping tolerance
:param bool scaling: whether to scale the optimization parameters (recommended)
